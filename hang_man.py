...
while (play_again == "Y"):
    ...
    hang_man_str = getpass.getpass(prompt='Player 1: Enter a word for hangman game: ')
    ...
    if((''.join(guessed)) == hang_man_str):
        ...
        print "Player 2: You suck at guessing!, go read a dictionary. Player 1 entered %s as the secret hangman word. " % hang_man_str
# Play again
